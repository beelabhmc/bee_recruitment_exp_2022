...
```{r}
bees_df %>%
  ggplot(aes(x = Treatment, y = Dances, fill = Flower_number, alpha = Density)) +
  geom_boxplot() +
  scale_alpha_manual(values = c(1, 0.3)) +
  labs(y = "Dances performed per bee") +
  facet_grid(Trial~Day) +
...
```{r}
bees_df %>%
  ggplot(aes(x = Treatment, y = Dance_rate, fill = Flower_number, alpha = Density)) +
  geom_boxplot() +
  scale_alpha_manual(values = c(1, 0.3)) +
...
```{r}
dances_df %>%
  ggplot(aes(x = Treatment, y = Total_runs, fill = Flower_number, alpha = Density)) +
  geom_boxplot() +
  scale_alpha_manual(values = c(1, 0.3)) +
